...
/*             "weapon_pistol_mk2", 
    ...
    Inventory.Open = function(data) {
        ...
        $("#craftingrep").find('span').html("<p>"+data.craftingrep+"</p>");
        $("#strength").find('span').html("<p>"+data.strength+"</p>");
        $("#stamina").find('span').html("<p>"+data.stamina+"</p>");
        $("#shooting").find('span').html("<p>"+data.shooting+"</p>");
        $("#driving").find('span').html("<p>"+data.driving+"</p>");
		$("#drugs").find('span').html("<p>"+data.dealerrep+"</p>");
        $("#policelevel").find('span').html("<p>"+data.policelevel+"</p>");
        if (requiredItemOpen) {
